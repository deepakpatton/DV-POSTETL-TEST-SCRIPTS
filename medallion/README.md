...
- `raw_stage_25_suite.csv`
- `silver_stage_25_suite.csv`
- `gold_stage_25_suite.csv`
- `all_stages_75_suite.csv`
...
The 25-check stage suites expand that further:

- Raw stage: 25 checks
- Silver stage: 25 checks
- Gold stage: 25 checks
- All stages combined: 75 checks
